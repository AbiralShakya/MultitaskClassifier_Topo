...
class HybridTopoClassifier(nn.Module):
    def __init__(self, cgcnn_node_dim, cgcnn_edge_dim, kspace_node_dim=10, kspace_edge_dim=4, kspace_physics_dim=202):
        super().__init__()
    ...
    def forward(self, crystal_graph, kspace_graph, kspace_physics_features):
        ...
        fused = torch.cat([cgcnn_out, kspace_gnn_out, kspace_transformer_out, kspace_physics_out], dim=1)
