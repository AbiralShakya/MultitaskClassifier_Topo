#!/usr/bin/env python3
"""
Working training that matches the actual dataset structure
"""
...
class WorkingOptimizedClassifier(nn.Module):
    """
    Working classifier that matches the actual dataset structure
    """
    ...
    def __init__(self):
        ...
        # Optimized fusion with self-attention (4 modalities)
    ...
    def forward(self, inputs):
        ...
        # Concatenate features (4 modalities)
...
def main():
    ...
    print("🚀 Working Optimized Training (4 Modalities)")
    print("=" * 50)
    ...
    # Test first sample to check data structure
    ...
    print(f"Physics features keys: {list(sample['kspace_physics_features'].keys())}")
    ...
    model = WorkingOptimizedClassifier().to(device)
    ...
    for epoch in range(50):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), 'best_working_model.pt')
    ...
    # Final evaluation
    model.load_state_dict(torch.load('best_working_model.pt'))
